...
<div class="container-fluid bg-breadcrumb">
    <div class="container text-center py-5" style="max-width: 900px;">
        <h3 class="text-white display-3 mb-4">Employees</h3>
    </div>
</div>
<!-- Travel Guide Start -->
<div class="container-fluid guide py-5">
    <div class="container py-5">
        <div class="mx-auto text-center mb-5" style="max-width: 900px;">
            <h5 class="section-title px-3">Employees</h5>
            <h1 class="mb-0">Meet Our Employees</h1>
        </div>
        <div class="row g-4">
                ...
                <div class="guide-item">
                    ...
                    <div class="guide-title text-center rounded-bottom p-4">
                        <div class="guide-title-inner">
                            <h4 class="mt-3">Jubayer Rahman</h4>
            ...
            <div class="col-md-6 col-lg-3">
                <div class="guide-item">
                    ...
                    <div class="guide-title text-center rounded-bottom p-4">
                        <div class="guide-title-inner">
                            <h4 class="mt-3">Adnan Hossen</h4>
                            <p class="mb-0">Sr. Software Engineer</p>
                        </div>
                    </div>
                </div>
            </div>
